...
export function EquiSaaSLogo({ className, lang = "en" }) {
  // A peak-level pure SVG geometric logo for EquiSaaS BD
  return (
    <div className={cn("flex items-center gap-3 select-none group", className)}>
      ...
      <div className="relative flex h-9 w-9 items-center justify-center shrink-0">
        ...
        >
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 h-2.5 w-2.5 rounded-full bg-emerald-500 shadow-[0_0_8px_rgba(16,185,129,0.8)]" />
        </motion.div>
      </div>
