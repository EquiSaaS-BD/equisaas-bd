...
const TabsList = React.forwardRef(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn("inline-flex min-h-11 items-center justify-center gap-1.5 rounded-[1.35rem] border border-border/60 bg-muted/70 p-1.5 text-muted-foreground", className)}
    {...props}
  />
));
