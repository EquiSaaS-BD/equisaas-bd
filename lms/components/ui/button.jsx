  ...
  "inline-flex items-center justify-center gap-2 rounded-xl border border-border/70 text-center text-sm font-semibold leading-snug whitespace-normal break-words ring-offset-background transition-all duration-200 ease-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none active:scale-[0.985]",
  {
    variants: {
      variant: {
        ...
        outline: "bg-background/80 text-foreground shadow-sm shadow-slate-950/5 backdrop-blur-sm hover:-translate-y-0.5 hover:border-primary/25 hover:bg-accent/70 hover:shadow-md",
        ghost: "border-transparent bg-transparent text-foreground shadow-none hover:bg-muted/70 hover:text-foreground",
        ...
        subtle: "border-primary/10 bg-primary/8 text-primary shadow-sm shadow-primary/10 hover:-translate-y-0.5 hover:bg-primary/12",
      },
      size: {
        default: "min-h-10 px-4 py-2.5",
        sm: "min-h-9 rounded-lg px-3 py-2 text-xs sm:text-sm",
